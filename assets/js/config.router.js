        ...
        function ($stateProvider, $httpProvider, $urlRouterProvider, JQ_CONFIG, $ocLazyLoadProvider) {
            ...
            $stateProvider
                ...
                .state('apps', {
                    ...
                    url: '/apps',
                    templateUrl: 'tpl/layout.html',
                    resolve:loadSequence('utilsService')
                })
                .state('apps.note', {
                    url: '/note',
                ...
                .state('app.chat', {//工作台消息
                 ...
                 .state('app.telephone', {//通讯录
                    abstract: true,
                    url:'/telephone',
                    templateUrl:'tpl/app_telephone.html',
                    resolve:loadSequence('telephoneCtrl')
                })
                .state('app.telephone.list', {
                    url: '/department/{dpId1}/{dpName}',
                    templateUrl:'tpl/app_telephone.list.html'
                ...
                .state('app.chat.content', {
                    ...
                    resolve:loadSequence("textAngular")
                })
                //聊天demo
                .state('app.chatDemo', {
                    url: '/chatDemo',
