app.controller('ContactCtrl', ['$scope', '$resource', '$filter', function($scope, $resource, $filter) {
  var requestService = {
    'query': $scope.app.hosts.baseUrl + 'contact/contacts.json'
  };
